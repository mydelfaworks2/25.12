export const predictions = [
    {
        id: 1,
        text: "Вы начнёте изучать новый язык и это откроет новые горизонты.",
    },
    { id: 2, text: "Вы обнаружите скрытый талант, который порадует вас." },
    {
        id: 3,
        text: "У вас появится возможность путешествовать и расширить свои горизонты.",
    },
    ...
    {
        id: 7,
        text: "Вы получите новую информацию, которая повлияет на ваше мнение.",
    },
    { id: 8, text: "На вас ждёт приятный сюрприз от родных." },
    { id: 9, text: "Вы научитесь управлять своими эмоциями." },
    {
        id: 10,
        text: "Вы встретите старого друга, который напомнит о добрых временах.",
    },
    { id: 11, text: "Вы обрете гармонию в личной жизни." },
    {
        id: 12,
        text: "Вы найдете время для любимого занятия, что улучшит настроение.",
    },
    { id: 13, text: "Ваша работа принесет признание и уважение." },
    {
        id: 14,
        text: "Вы примете участие в интересном проекте, который вас вдохновит.",
    },
    ...
    {
        id: 20,
        text: "Вы откроете для себя новые литературные произведения, которые вдохновят.",
    },
    // text: "барсик пройдёт nfg lp"
];
